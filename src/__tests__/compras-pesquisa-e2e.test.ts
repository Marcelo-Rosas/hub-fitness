...
import { pickComprasResearchFallback } from '../core/compras/comprasResearchPack';
...
describe('rota fallback 5.1.01.03 (sem HTTP)', () => {
  it('pickComprasResearchFallback → exatamente 3 cotações Fitas PET', () => {
    const pack = pickComprasResearchFallback('5.1.01.03');
    const parsed = parseResearchIngest(JSON.stringify(pack), 'compras');
